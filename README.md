谢绝将配网库修改进行商业项目 或不注明来源 强制做为自己项目在网络中分享。 请尊重开源协议，谢谢！  
...
* v1.1.6：优化连接网络逻辑，增加OTA功能 详情请查看ota_demo 加入程序版本号返回 ，输出信息改为 wifilinktoos版本号 和程序版本号 增加向服务器请求（服务端不会收集任何设备信息 只记录请求次数不放心可以注释gethttp_API("http://keai.icu/wifilinktool/up",80);）。
****
